...
// let ticketPriceTotal = [runners.donation.re];
// console.log(ticketPriceTotal);

// no clue how to do this one. Need to ask a PM for clarification
...
// Problem 1
// find email adddress
comapanyEmail = runners.map(email => email.email)
console.log(comapanyEmail);
// Problem 2
// create a list of companys who are partcipating
employeer = runners.map(boss=>boss.company_name)
console.log(employeer)
// Problem 3
introductions = []

runners.forEach(runners => introductions.push(`Hi! My name is ${runners.first_name} and I work for ${runners.company_name}`));
